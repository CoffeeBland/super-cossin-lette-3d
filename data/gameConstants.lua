return {
    ...
    tutorialCutscene = {
        ...
        { "move",
            ...
            { "lookAt", point = { byName = "cossin", offset = { x = -1, y = 1 } } },
            { "waitFrames", 30 },
            { "walkTo", point = { byName = "picnic", offset = { x = 600, y = 40 } } },
            { "waitFrames", 45 },
            { "walkTo", point = { byName = "picnic", offset = { x = 600, y = 40 } } },
            { "lookAt", point = { byName = "picnic" } },
        },
        ...
        { "move",
            entity = { byName = "cossin" },
            { "walkTo", point = { byName = "fruit1", offset = { x = -400, y = 400 } } },
        },
        { "waitForMove", entity = { byName = "cossin" } },
        { "bubble",
            entity = { byName = "cossin" },
        ...
        { "move",
            ...
            { "walkTo", point = { byName = "arch", offset = { x = 600, y = -600 } } },
        },
        { "waitForMove", entity = { byName = "cossin" } },
        ...
        { "move",
            entity = { byName = "cossin" },
            { "walkTo", point = { byName = "arch", offset = { x = -100, y = 400 } } },
            { "walkTo", point = { byName = "tree", offset = { x = 300, y = 0 } } },
            { "jump", jumpSpeed = 150 },
            { "jump", jumpSpeed = 150 },
            { "walkTo", point = { byName = "picnic", offset = { x = -300, y = -300 } } },
        },
        { "waitForMove", entity = { byName = "cossin" } },
