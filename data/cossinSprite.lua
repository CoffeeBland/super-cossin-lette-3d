    ...
    sprites = {
        cossinCorps = {
            ...
            -- Walk
            {
                ...
                fps = 25,
                pingPong = true,
                tiles = { { 0, 0 }, { 1, 0 }, { 2, 0, "step" }, { 3, 0 }, { 4, 0 } }
            },
            {
                name = "walk",
                dirs = { "bl"},
                fps = 25,
                pingPong = true,
                tiles = { { 0, 1 }, { 1, 1 }, { 2, 1, "step" }, { 3, 1 }, { 4, 1 } }
            },
            {
                name = "walk",
                dirs = { "l"},
                fps = 25,
                pingPong = true,
                tiles = { { 0, 2 }, { 1, 2 }, { 2, 2, "step" }, { 3, 2 }, { 4, 2 } }
            },
            {
                name = "walk",
                dirs = { "tl" },
                fps = 25,
                pingPong = true,
                tiles = { { 0, 3 }, { 1, 3 }, { 2, 3, "step" }, { 3, 3 }, { 4, 3 } }
            },
            {
                name = "walk",
                dirs = { "t" },
                fps = 25,
                pingPong = true,
                tiles = { { 0, 4 }, { 1, 4 }, { 2, 4, "step" }, { 3, 4 }, { 4, 4 } }
            },
            {
                name = "walk",
                dirs = { "br"},
